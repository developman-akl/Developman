{{-- <section id="about" class="w-screen min-h-full overflow-hidden md:px-0 px-2 py-12 bg-gradient-to-b from-[#ECECEC] to-white"> --}}
<section id="about" class="w-screen min-h-full overflow-hidden md:px-0 px-2 py-12 bg-[#FEFEFE]">
    <h1 class="lg:text-4xl xl:text-5xl mb-24 text-3xl font-extrabold tracking-wider text-center text-[#001E4F]">
        <span>ABOUT</span>
    </h1>
    <div class="font-content xl:px-5 container items-center max-w-6xl px-8 pb-16 mx-auto my-auto font-semibold text-right">
