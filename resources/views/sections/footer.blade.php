        ...
        <div class="flex flex-col space-y-10">
            ...
            <div class="sm:text-right lg:justify-end flex justify-center mb-0 text-center">
                <span class="sm:ml-auto sm:justify-start sm:space-x-5 space-x-14 inline-flex">
                    <a href="mailto:info@developman.tech" class="hover:text-dvlpmn-blue-light text-dvlpmn-blue-dark hover:scale-125 duration-700 transform" target="_blank" title="Email">
                    ...
                    <a href="https://www.linkedin.com/in/j%C3%A1nos-moln%C3%A1r-6044a34a/" class="hover:text-dvlpmn-blue-light text-dvlpmn-blue-dark hover:scale-125 duration-700 transform" target="_blank" title="LinkedIn">
                        <span class="sr-only">LinkedIn</span>
                    ...
                    <a href="https://github.com/developman-akl" class="hover:text-dvlpmn-blue-light text-dvlpmn-blue-dark hover:scale-125 duration-700 transform" target="_blank" title="GitHub">
