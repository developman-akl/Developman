    ...
    <div class="max-w-7xl sm:flex-row lg:justify-between container flex flex-wrap items-center justify-center py-5 mx-auto">
        ...
        <div class="flex flex-col space-y-10">
            <div class="sm:mt-0 sm:text-left sm:flex-row flex flex-col mt-8 font-black tracking-wider text-center uppercase">
                <span class="text-dvlpmn-blue-light mr-2">Custom Solutions,</span>
            ...
            <div class="sm:text-right lg:justify-end flex justify-center mb-0 text-center">
                <span class="sm:ml-auto sm:justify-start sm:space-x-5 space-x-14 inline-flex">
                    ...
                    <a href="https://www.linkedin.com/in/j%C3%A1nos-moln%C3%A1r-6044a34a/" class="hover:text-dvlpmn-blue-light text-dvlpmn-blue-dark hover:scale-125 duration-700 transform" target="_blank" title="LinkedIn" rel="noreferrer">
                        <span class="sr-only">LinkedIn</span>
                    ...
                    <a href="https://github.com/developman-akl" class="hover:text-dvlpmn-blue-light text-dvlpmn-blue-dark hover:scale-125 duration-700 transform" target="_blank" title="GitHub" rel="noreferrer">
