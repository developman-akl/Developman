<footer class="body-font relative min-h-full text-gray-700 bg-white">
    <div class="max-w-7xl sm:flex-row lg:justify-between container flex flex-wrap items-center justify-center py-5 mx-auto">
        <div class="flex flex-col space-y-2 tracking-wide">
            ...
            <div class="sm:text-left ml-5 text-sm text-center text-dvlpmn-blue-dark">
        ...
        <div class="flex flex-col space-y-10">
            <div class="text-dvlpmn-blue-light uppercase font-black tracking-wider mt-8 sm:mt-0 sm:text-left text-center">
            ...
            <div class="sm:text-right lg:justify-end flex justify-center mb-0 text-center">
                <span class="sm:ml-auto sm:justify-start sm:space-x-5 space-x-14 inline-flex">
                    <a href="mailto:info@developman.tech" class="hover:text-dvlpmn-blue-light text-dvlpmn-blue-dark duration-700 transform hover:scale-125" target="_blank" title="Email">
                    ...
                    <a href="https://www.linkedin.com/in/j%C3%A1nos-moln%C3%A1r-6044a34a/" class="hover:text-dvlpmn-blue-light text-dvlpmn-blue-dark duration-700 transform hover:scale-125" target="_blank" title="LinkedIn">
                        <span class="sr-only">LinkedIn</span>
                        <svg xmlns="http://www.w3.org/2000/svg" class="w-12 h-12" fill="currentColor" viewBox="0 0 1000 1000">
                            <path 
                    ...
                    <a href="https://github.com/developman-akl" class="hover:text-dvlpmn-blue-light text-dvlpmn-blue-dark duration-700 transform hover:scale-125" target="_blank" title="GitHub">
