<section x-cloak class="body-font relative w-full px-8 text-gray-700 bg-white">
    <div class="md:flex-row max-w-7xl container flex flex-col flex-wrap items-center justify-between py-5 mx-auto">
        ...
        <nav class="md:ml-5 lg:justify-end relative z-10 inline-flex items-center space-x-8 text-xl">
            <a href="#_" class="hover:text-gray-900 relative font-medium leading-6 text-gray-600 transition duration-150 ease-out" x-data="{ hover: false }" @mouseenter="hover = true" @mouseleave="hover = false">
